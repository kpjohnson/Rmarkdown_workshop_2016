...
\caption{Here's my caption 2\label{fig:fig_example}}
\end{figure}
...
in line without dollar signs, if in math mode you need dollar signs. ex:
\(\%\)
...
X & Size & Color \\ 
  \hline
Lee CF & XL & Maroon \\ 
  Kristin PJ & M & Dark Green \\ 
  Lukas DF & L & Light Blue \\ 
  Thomas B & S & Maroon \\ 
  Kaija K & S & Light Blue \\ 
  Zack O & M & Dark Green \\ 
  Zach K & M & Lavender \\ 
  Kate R & S & Light Blue \\ 
  Jon S & L & Purple \\ 
  Melissa K & M & Light Blue \\ 
   \hline
\end{tabular}
}
\end{table}
